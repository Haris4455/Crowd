...
class SignupForm(forms.ModelForm):
	...
	email = forms.CharField(widget=forms.EmailInput(attrs={'placeholder':'  @student.usa.edu.pk'}), max_length=100, required=True, )
	...
	def clean_email(self):
		...
		if "@student.usa.edu.pk" not in data:  # any check you need
			raise forms.ValidationError("Must be a USA student to sign up...!")
		return data
